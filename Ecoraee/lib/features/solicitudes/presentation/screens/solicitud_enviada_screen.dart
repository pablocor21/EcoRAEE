...
class SolicitudEnviadaScreen extends StatelessWidget {
  const SolicitudEnviadaScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFE8EEDF), // Fondo claro ligeramente verdoso
        border: Border(
          top: BorderSide(
